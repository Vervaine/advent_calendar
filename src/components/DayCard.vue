<template>
    <label class="swap card place-content-stretch">
        ...
        <div class="swap-on bg-white text-black py-3 px-4 font-semibold overflow-y-scroll z-10" style="box-shadow: inset 0 0 10px 2px rgba(0,0,0,0.75)" v-if="isAllowedToBeDisplayed">
